...
public class Vote {
    ...
    public Vote(Vote vote) {
        this.id = vote.id;
        this.informationId = vote.informationId;
    ...
    public String toString() {
        return "Vote [id=" + id + ", informationId=" + informationId + ", userId=" + userId + ", date="
    ...
    public int hashCode() {
        ...
        result = prime * result + (int) (informationId ^ (informationId >>> 32));
